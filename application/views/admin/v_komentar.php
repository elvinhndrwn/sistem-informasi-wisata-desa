        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                   ...
                   <?php if($k->seen == 0){$background="#c5eceb";}else{$background="";} ?>
                   ...
                   <tr style="background-color: <?= $background ?>">
                    ...
                    <td><?= date('d F Y - H:i', strtotime($k->tgl_komentar)) ?></td>
                    <td>
                        <a class="btn btn-sm btn-danger btn-hapus"  href="<?php echo base_url('admin/komentar_hapus/'.$k->id_komentar) ?>"><i class="far fa-trash-alt"></i></a>

                        <a class="btn btn-sm btn-success btn-verifikasi" id="btn-verifikasi"  href="<?php echo base_url('admin/komentar_verifikasi/'.$k->id_komentar) ?>"><i class="fas fa-check-double"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
